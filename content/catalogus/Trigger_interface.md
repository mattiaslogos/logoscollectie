...
menu = "main"
summary = "<a href='/logoscollectie/catalogus/1983/trigger_interface'><img src='/logoscollectie/catalogus/img/Trigger_interface/Trigger%20interface%20bovenkant-thumb.jpg'></a>Met deze interface kunnen analoge klanken omgezet worden in triggersignalen om zo spanningsgestuurde modules van synthesizers aan te sturen."
+++

# Trigger interface

![alt text][afb1]
[afb1]: /logoscollectie/catalogus/img/Trigger_interface/Trigger%20interface%20bovenkant-thumb.jpg "Trigger interface"
...
##### Afbeeldingen
{{< load-photoswipe >}}
{{< gallery dir="/catalogus/img/Trigger_interface" />}}

##### pdf-bestanden
[Elektrisch schema trigger interface](/logoscollectie/catalogus/pdf/Trigger_interface/Elektrisch_schema_trigger_interface.pdf)

[Scan trigger interface](/logoscollectie/catalogus/pdf/Trigger_interface/Scan_trigger_interface.pdf)
